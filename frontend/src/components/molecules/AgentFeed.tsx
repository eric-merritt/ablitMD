...
export const AgentFeed = ({ feed, stage, onReclassify }: { feed: LiveTrial[]; stage: string | null; onReclassify: (index: number) => void }) => (
  <div style={{ background: 'var(--bg)', border: '1px solid var(--border)', borderRadius: 'var(--radius)', padding: '16px', display: 'flex', flexDirection: 'column', gap: '8px', flex: 1, minHeight: 0 }}>
